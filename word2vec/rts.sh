echo The script is used to illustrate the effectiveness of global information on RTs dataset
echo We use texts of IMDB dataset as training samples and all texts of RTs as testing samples

gcc word2vec.c -o word2vec -lm -pthread -O3 -march=native -funroll-loops

# IMDB dataset (50000 texts) + RTs dataset (10662 texts)
cat ../data/full-train-pos.txt ../data/full-train-neg.txt ../data/test-pos.txt ../data/test-neg.txt ../data/rt-polarity.pos ../data/rt-polarity.neg > alldata.txt
...
for global in 0.0 0.5 1.0; do
    ...
    head sentence_vectors.txt -n 60662 | tail -n 10662 | awk 'BEGIN{a=0;}{if (a<5331) printf "1 "; else printf "-1 "; for (b=1; b<NF; b++) printf b ":" $(b+1) " "; print ""; a++;}' > test.txt
